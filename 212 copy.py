...
pygame.display.set_caption("Alt-F4")  # Change the window title
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
GREEN = (0, 255, 0)
RED = (255, 0, 0)
...
extra_small_font = pygame.font.SysFont("Arial", 20)

player_image = pygame.image.load("menu.png")  # Resminizin yolu

icon_image = pygame.image.load("menu.png")  
pygame.display.set_icon(icon_image)  


# Resmi yeniden boyutlandırma (örnek boyut 150x150)
...
def show_menu():
    ...
    while True:
        ...
        # Menü başlığı
        title_text = font.render("Welcome to the 'Alt-F4' game", True, WHITE)
        screen.blit(title_text, (screen_width / 2 - title_text.get_width() / 2, 100))
        
        # Yeni yazı
        subtitle_text = extra_small_font.render("Furkan Turan - Taha Mert Yıldız - Burak Can Şen", True, WHITE)
